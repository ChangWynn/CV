...
|:----:|:-----------|:----------:|
|[WMUZIC](https://wmuzic-3020e.web.app/) | WORK STILL IN PROGRESS - A music manager app where a user can upload its music files and listen to them. The app uses the Spotify API to collect title metadata and images. The app also includes animations made with the Framer-Motion library for React |  React, Firebase Authentication, Firebase Storage, Framer-Motion
