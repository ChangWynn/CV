...
|:----:|:-----------|:----------:|
| <a href="https://wmuzic-3020e.web.app/" target="_blank">WMUZIC</a> | WORK STILL IN PROGRESS - A music manager app where a user can upload its music files and listen to them. The app uses the Spotify API to collect title metadata and images. The backend rely on Firebase services and the app also includes animations made with the Framer-Motion library for React |  React, Firebase Auth, Firebase Storage, Firebase Hosting, Framer-Motion
