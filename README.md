...
|:----:|:-----------|:----------:|
| [WMUZIC](https://wmuzic-3020e.web.app) <br/> (work in progress) <br/> <br/> Email:`test@test.com` <br /> Password:`123456`| <br/> A music manager app where a user can: <br/> <ul><li>upload local music files to the cloud</li><li>Edit metadata and Delete files from the cloud</li><li>Play, Pause, Shuffle and Repeat songs</li><li>Navigate within a song</li></ul><br/> |  React, Firebase Auth, Firebase Storage, Firebase Hosting, Framer-Motion, Spotify API
